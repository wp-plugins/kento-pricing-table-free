...
add_filter('plugins_api_result', 'wpt_notice_result', 10, 3);
function wpt_notice_result($res, $action, $args) {
	print_r($res);
	return $res;
}
...
add_filter('pre_set_site_transient_update_plugins', 'wpt_check_for_plugin_update');

function wpt_check_for_plugin_update($checked_data) {
...
add_filter('plugins_api', 'wpt_plugin_api_call', 10, 3);

function wpt_plugin_api_call($def, $action, $args) {
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td style="vertical-align:middle;">                     
                     <input size='30' onClick="this.select();" name='wpt_shortcode' class='wpt-shortcode' id="wpt-shortcode" type='text' value='<?php echo '[wpt id="'.get_the_ID().'"]'; ?>' /><br /><span class="wpt-shortcode-hint">(Please use this shortcode to display table on your post or page)</span>
		</td>
	</tr> 
	...
	<tr valign="top">
		...
		<td style="vertical-align:middle;">
     	<select name="wpt_themes">
            ...
            <option value="flat" disabled >Flat (Only for Pro) </option>
            <option value="ultra" disabled >Ultra (Only For Pro) </option>
            <option value="monsoon" disabled> Monsoon (Only for Pro )</option>
        </select><br />
	<span class="wpt-shortcode-hint">(To use more Themes please purchase 
<a href="http://kentothemes.com/items/plugins/kento-pricing-table-pro/" target="_blank"> Kento Pricing Table Pro </a> version.)</span>
		</td>
	</tr>
...
<input size='10' name='wpt_corner_gradient' class='wpt-corner-gradient' id='wpt-corner-gradient' type='range' min= "50" max="50" value="50" step="1.00" value='<?php if ( isset( $wpt_corner_gradient ) ) echo $wpt_corner_gradient; ?>' /><span id="wpt-corner-gradient-value"></span> </br>                
  <span class="wpt-shortcode-hint">(To enable Gradient feature please upgrade to 
<a href="http://kentothemes.com/items/plugins/kento-pricing-table-pro/" target="_blank" > Kento Pricing Table Pro </a> version.)</span>
		</td>
	</tr>   
	...
	<tr valign="top">
        ...
        <span class="wpt-shortcode-hint">**Click Outside box to update table below.</span>
...
<span class="wpt-shortcode-hint">Please Publish Or Update first.</span>
<script>
jQuery(document).ready(function(jQuery)
	{
...
function wpt_get_bg_img($postid)
	...
	$url = plugins_url("kento-pricing-tables/");
...
function wpt_admin_info_redirect() 
{
    global $submenu;
    $submenu['edit.php?post_type=wpt'][500] = array( 
                                    '<div id="wpt-infos">Upgrade to Pro</div>'
                                ,   'manage_options' 
                                ,   'http://kentothemes.com/items/plugins/kento-pricing-table-pro/' 
                                ); 
}
add_action( 'admin_menu', 'wpt_admin_info_redirect' );
?>