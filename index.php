...
function kpt_script()
	{
		...
		wp_enqueue_script('kpt-ajax-js', plugins_url( '/js/kpt-ajax.js' , __FILE__ ) , array( 'jquery' ));
		wp_localize_script( 'kpt-ajax-js', 'kpt_ajax', array( 'kpt_ajaxurl' => admin_url( 'admin-ajax.php')));
	}
